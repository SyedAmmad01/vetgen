...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('front_assets')}}/assets/css/lineicons.css" />
    <link rel="stylesheet" href="{{asset('front_assets')}}/assets/css/materialdesignicons.min.css" />
