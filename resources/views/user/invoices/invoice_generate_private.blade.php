...
@section('page_title', 'Invoice Generate Private')
        ...
        <div class="container-fluid">
            ...
            <div class="title-wrapper pt-30">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="title">
                            <h2>Invoice Generate Private</h2>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="breadcrumb-wrapper">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Invoice Generate Private</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <!-- Form -->
            <form class="form-validate" action="{{ route('user.invoices.invoices_private_store') }}" method="post"
                            ...
                            <div class="card-style mb-30">
                                <div class="row">
                                    ...
                                    <div class="col-md-6"><label>Billing Period</label><input type="text"
                                            name="billing_period" class="form-control" placeholder="Billing Period"></div>
                                    ...
                                    <div class="col-md-6"><label>Sub Total</label><input type="text" id="sub_total" name="sub_total"
                                            class="form-control" value="0" ></div>
                                    <div class="col-md-6"><label>Discount</label><input type="text" id="discount" name="discount"
                                            class="form-control" value="0"></div>
                                    <div class="col-md-6"><label>Total</label><input type="text" id="total" name="total"
                                            class="form-control" value="0" ></div>
...
@section('page-scripts')
    ...
    <script>
        ...
        function calculateGrandTotal() {
            ...
            // Grand total after subtracting discount and advance
