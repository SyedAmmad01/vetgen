                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                +92 323 2323128<br>
                                <a href="https://www.vetgen.com.pk" target="_blank">www.vetgen.com.pk</a>
                            </td>
                        ...
                        <tr>
                            <td>
                                <strong>NTN:</strong> {{ $invoice->ntn }}<br>
                                <strong>Client NTN:</strong> {{ $invoice->client_ntn_number }}
                            </td>
                            <td>
                                <strong>SRB:</strong> {{ $invoice->srb }}<br>
                                <strong>Tax %:</strong> {{ $invoice->percentage }}%
                            </td>
                        </tr>
