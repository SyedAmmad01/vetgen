...
class OrderController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('user.order.create', compact( 'invoice', 'users', 'fumigations', 'cleanings', 'lead_ref', 'time_of_services'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($order) {
            ...
            return redirect()->back()->with('msg', 'Order could not be saved.');
        }
    }
